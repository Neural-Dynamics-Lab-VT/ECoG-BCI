...
text { caption = "For the tongue emoji, please imagine sticking your tongue out";} instr_text_2;
text { caption = "For the ball emoji, please imagine kicking a ball";} instr_text_3;
text { caption = "Please do not close your eyes to imagine.";} instr_text_4;
text { caption = "";} no_text;

# Array for the text
array {
   text { caption = "Imagine sticking your tongue out."; description = "Tongue"; } left;
   text { caption = "Imagine kicking a ball"; description = "Ball"; } right; 
	text { caption = ""; description = "No Arrow";} no_arrow;
} arrows;

# Array for the images
array {
   bitmap { filename = "tongue.jpg"; description = "Left Arrow Picture"; } left_pic;
   bitmap { filename = "ball.jpg"; description = "Right Arrow Picture"; } right_pic;
